...
if(firstCardNum + secondCardNum === '1A' || firstCardNum + secondCardNum === 'JA' || firstCardNum + secondCardNum === 'QA' || firstCardNum + secondCardNum === 'KA' ){
  alert('BlackJack You Win')
  location.reload();
}else if(firstCardNum + secondCardNum === 'A1' || firstCardNum + secondCardNum === 'AJ' || firstCardNum + secondCardNum === 'AQ' || firstCardNum + secondCardNum === 'AQ' ){
  alert('BlackJack You Win')
  location.reload();
}
...
function firstCardNumFunc (){
  let firstCardNum = firstCardN.charAt(0)
  if(firstCardNum === '2' || firstCardNum === '3' || firstCardNum === '4' || firstCardNum === '5' || firstCardNum === '6' || firstCardNum === '7' || firstCardNum === '8' || firstCardNum === '9'){
     return firstCardN = firstCardNum;
  }else if( firstCardNum === 'J' || firstCardNum === 'K' || firstCardNum === 'Q' || firstCardNum === '1'){
...
function secondCardNumFunc (){
  let secondCardNum = secondCardN.charAt(0)
  if(secondCardNum === '2' || secondCardNum === '3' || secondCardNum === '4' || secondCardNum === '5' || secondCardNum === '6' || secondCardNum === '7' || secondCardNum === '8' || secondCardNum === '9'){
     return secondCardN = secondCardNum;
  }else if(secondCardNum === 'J' || secondCardNum === 'K' || secondCardNum === 'Q' || secondCardNum === '1'){
...
hit.addEventListener('click', function(){
  ...
  if(hitCardNum === '2' || hitCardNum === '3' || hitCardNum === '4' || hitCardNum === '5' || hitCardNum === '6' || hitCardNum === '7' || hitCardNum === '8' || hitCardNum === '9'){
     return hitCardN = hitCardNum;
  }else if(hitCardNum === 'J' || hitCardNum === 'K' || hitCardNum === 'Q' || hitCardNum === '1'){
    return hitCardN = '10'
...
stand.addEventListener('click', function(){
  ...
  if(dealerHiddenCardNum + dealerCardNum === '1A' || dealerHiddenCardNum + dealerCardNum === 'JA' || dealerHiddenCardNum + dealerCardNum === 'QA' || dealerHiddenCardNum + dealerCardNum === 'KA' ){
    alert('Dealer BlackJack You Lost')
    location.reload();
  }else if(dealerHiddenCardNum + dealerCardNum === 'A1' || dealerHiddenCardNum + dealerCardNum === 'AJ' || dealerHiddenCardNum + dealerCardNum === 'AQ' || dealerHiddenCardNum + dealerCardNum === 'AQ' ){
    alert('Dealer BlackJack You Lost')
    location.reload();
  }
  ...
  function dealerHiddenCardNumFunc (){
    let dealerHiddenCardNum = dealerHiddenCardN.charAt(0)
    if(dealerHiddenCardNum === '2' || dealerHiddenCardNum === '3' || dealerHiddenCardNum === '4' || dealerHiddenCardNum === '5' || dealerHiddenCardNum === '6' || dealerHiddenCardNum === '7' || dealerHiddenCardNum === '8' || dealerHiddenCardNum === '9'){
       return dealerHiddenCardN = dealerHiddenCardNum;
    }else if( dealerHiddenCardNum === 'J' || dealerHiddenCardNum === 'K' || dealerHiddenCardNum === 'Q' || dealerHiddenCardNum === '1'){
  ...
  function dealerShownCardNumFunc (){
    let dealerCardNum = dealerCardN.charAt(0)
    if(dealerCardNum === '2' || dealerCardNum === '3' || dealerCardNum === '4' || dealerCardNum === '5' || dealerCardNum === '6' || dealerCardNum === '7' || dealerCardNum === '8' || dealerCardNum === '9'){
       return dealerCardN = dealerCardNum;
    }else if(dealerCardNum === 'J' || dealerCardNum === 'K' || dealerCardNum === 'Q' || dealerCardNum === '1'){
  ...
  while(dealerTotalNum < 17){
    ...
    function dealerNewCardNumFunc (){
      ...
      }else if( dealerNewCardNum === 'J' || dealerNewCardNum === 'K' || dealerNewCardNum === 'Q' || dealerNewCardNum === '1'){
  ...
  if(dealerTotalNum >21){
    alert(`Dealer Total: ${dealerTotalNum}. Your Total: ${playerTotalNum} You Win`)
  } else if(dealerTotalNum === 21){
    alert(`Dealer Total: ${dealerTotalNum}. Your Total: ${playerTotalNum} You Lost`)
